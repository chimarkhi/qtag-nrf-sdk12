...
extern volatile uint8_t syncType;
...
extern uint8_t check_startRecKey(uint16_t inRecKey, uint16_t currentRecKey);

uint8_t check_nusRecKey(uint16_t inRecKey, uint16_t currentKey);
